...
class Sprite extends Object3D {
  ...
  void raycast(Raycaster raycaster, List<Intersection> intersects) {
    ...
    modelViewMatrix.multiplyMatrices(
        raycaster.camera?.matrixWorldInverse ?? Matrix4(), matrixWorld);
    ...
    transformVertex(
      _spritevA.set(-0.5, -0.5, 0),
      _mvPosition,
      center,
      Vector2(_worldScale.x, _worldScale.y),
      sin,
      cos,
    );
    transformVertex(
      _spritevB.set(0.5, -0.5, 0),
      _mvPosition,
      center,
      Vector2(_worldScale.x, _worldScale.y),
      sin,
